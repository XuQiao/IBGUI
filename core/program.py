...
class TestApp(TestWrapper, TestClient):
    def __init__(self):
        ...
        self.done = False
        self.ret = collections.defaultdict(set)
        self.msgs = []
    ...
    def error(self, reqId: TickerId, errorCode: int, errorString: str):
        ...
        self.ret['Error'].add(Hashabledict({"Id": reqId, "Code": errorCode, "Msg": errorString}))
    ...
    def orderStatus(self, orderId: OrderId, status: str, filled: float,
        ...
        results = {"Id": orderId, "Status": status, "Filled": filled,
    ...
    def position(self, account: str, contract: Contract, position: float,
        ...
        results = {"Account": account, 'ConId': contract.conId, "Symbol": contract.symbol, "SecType":
    ...
    def historicalData(self, reqId:int, bar: BarData):
        results = {"ReqId:", reqId, "BarData.", bar}
        self.ret["HistoricalData"].add(Hashabledict(results,name="HistoricalData"))
...
#              "Projection:", projection, "Legs String:", legsStr)
    ...
    def fundamentalsOperations_req(self):
        ...
        self.reqFundamentalData(8003, contract, "ReportRatios", []); # for financial ratios
    ...
    def fundamentalData(self, reqId: TickerId, data: str):
        ...
        results = {"reqId": reqId, "Data:": data}
        self.ret["FundamentalData"].add(results)
    ...
    def completedOrder(self, contract: Contract, order: Order,
        ...
        results = {"PermId": order.permId, "ParentPermId": utils.longToStr(order.parentPermId), "Account": order.account,
        ...
        self.ret["CompletedOrder"].add(Hashabledict(results))
